    ...
    return (
        <div>
            {props.usersPage.users.map(u => <div className={styles.userCard} key={u.id}>
                <img src={u.photos.small !== null ? u.photos.small : 'https://abrakadabra.fun/uploads/posts/2021-12/1638968482_1-abrakadabra-fun-p-grustnii-pepe-1.png'} className={styles.userPhoto}/>
